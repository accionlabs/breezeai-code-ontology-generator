...
function collectQueryStatements(node, source, statements) {
  ...
  traverse(node, (n) => {
    // C# invocation: command.ExecuteReader(), context.Database.ExecuteSqlRaw()
    if (n.type === "invocation_expression") {
      const functionNode = n.child(0);
      ...
      if (functionNode.type === "identifier") {
        ...
        objectName = objectNode ? source.slice(objectNode.startIndex, objectNode.endIndex) : null;
      }
